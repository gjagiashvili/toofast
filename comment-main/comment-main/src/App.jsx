...
const App = () => {
  ...
  const handleCommentEditComplete = (updatedComments) => {
    setDataState({
      ...dataState,
  ...
  const handleReplyEditComplete = (updatedReplies, commentIndex) => {
...
<Comment
  ...
  onEditComplete={handleCommentEditComplete} 
  onDelete={(replyIndex) => deleteReply(index, replyIndex)}
